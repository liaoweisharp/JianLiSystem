<%@ Page Title="填写个人信息" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Users.aspx.cs" Inherits="RL_Users" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script src="../RL/JS/Base_RenLi.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_JingLi_GongCheng.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_JingLi_XueXi.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_JingLi_GongZuo.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_XueLi.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_ZhiCheng.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_ZhiYeZiGet.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_XinChou.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_XinChou_KouKuanJiangLi.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_PeiXun.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_DiaoDong.js" type="text/javascript"></script>
    <script src="../Scripts/Comm/TextSelect.js" type="text/javascript"></script>
    <script src="../RL/JS/Base_User_JiangCheng.js" type="text/javascript"></script>
...
<center style='margin:100px;'><asp:Button ID="Button1" runat="server" Text="继续填写，重新打开"></asp:Button>&nbsp;<asp:Button 
        ID="Button2" runat="server" Text="我已填好，退出系统" onclick="Button2_Click" 
        style="height: 21px"></asp:Button></center>
    <div  style='width:95%; margin:0px auto;display:none;'>
