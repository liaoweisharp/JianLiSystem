(function () {
    ...
    function createJson() {
        ...
        jsonArray.push({ itemId: "kkjl_Type", type: "select", title: "扣款或奖金", required: true, init: [{ id: '1', title: "扣款(不参与个税计算) " }, { id: '3', title: "扣款(先减再计算个税) " }, { id: '2', title: "奖金(不参与个税计算)" }, { id: '4', title: "奖金（先加再计算个税）"}] });
