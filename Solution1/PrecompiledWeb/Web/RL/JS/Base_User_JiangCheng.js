(function () {
    ...
    var requireColumn = ["rl_jc_SuoShuXiangMu", "rl_jc_RiQi",  "rl_jc_YuanYin"];
    JC.Prefix = "JC_";
    ...
    function successCallBack(result, context) {
        if (context.userContent == "getJiangChengByUserId") {
            ...
            if (data.length == 0) {
                ...
                $("#" + JC.Prefix + userId).html(html_ShowTable(data, userId, type));
    ...
    function createJson() {
        ...
        jsonArray.push({ itemId: "rl_jc_SuoShuXiangMu", type: "text", title: "所属项目" });
