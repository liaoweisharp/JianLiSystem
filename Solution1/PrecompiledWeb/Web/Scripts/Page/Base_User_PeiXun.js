(function () {
    ...
    var requireColumn = ["rl_px_BuMen",  "rl_px_PeiXunXiangMu", "rl_px_PeiXunLeiBie2", "rl_dd_YingLingXinChou"];
    PX.Prefix = "PX_";
    ...
    function createJson() {
        ...
        jsonArray.push({ itemId: "rl_px_XiangMuId", type: "select", title: "所属项目",  init: getInit(baseData["项目"]) });
